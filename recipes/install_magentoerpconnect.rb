...
unless File.exists?("#{node[:magento][:dir]}/installed_code_connector.flag")
  ...
  execute "ln -s /home/#{node[:webserver][:unix_user]}/magentoerpconnect/Openlabs_OpenERPConnector-1.1.0/app/etc/modules/Openlabs_OpenERPConnector.xml #{node[:magento][:dir]}/app/etc/modules/Openlabs_OpenERPConnector.xml" do
  ...
  execute "ln -s /home/#{node[:webserver][:unix_user]}/magentoerpconnect/Openlabs_OpenERPConnector-1.1.0/Openlabs #{node[:magento][:dir]}/app/code/community" do
